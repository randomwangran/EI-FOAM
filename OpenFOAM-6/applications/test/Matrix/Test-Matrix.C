...
int main(int argc, char *argv[])
{
    ...
    scalarSquareMatrix testA(n,n);
    scalarSquareMatrix testB(n,n);
    scalarSquareMatrix testC(n,n);
    ...
    //-wr    std::clock_t start;
    //-wr    testC = testA * testB;
    //-wr    std::clock_t end;
    //-wr
    //-wr    double duration;
    //-wr
    //-wr    duration = ( end - start ) / (double) CLOCKS_PER_SEC;
    //-wr
    //-wr    Info<< start << end <<duration << endl;
    return 0;
}
